...
export const runtimeConfig =
	typeof window !== 'undefined'
		...
		: {
				...
				LANG: nodeIsProduction
					? process.env.LANG
					: process.env.RAZZLE_LANG,
				...
				THEME: nodeIsProduction
					? process.env.THEME
					: process.env.RAZZLE_THEME,
				...
				NAME: nodeIsProduction
					? process.env.NAME
					: process.env.RAZZLE_NAME,
				BIO: nodeIsProduction
					? process.env.BIO
					: process.env.RAZZLE_BIO,
				...
				KIT: nodeIsProduction
					? process.env.KIT
					: process.env.RAZZLE_KIT,
				...
				EMAIL: nodeIsProduction
					? process.env.EMAIL
					: process.env.RAZZLE_EMAIL,
				...
				FIGMA: nodeIsProduction
					? process.env.FIGMA
					: process.env.RAZZLE_FIGMA,
				...
				STEAM: nodeIsProduction
					? process.env.STEAM
					: process.env.RAZZLE_STEAM,
				VIMEO: nodeIsProduction
					? process.env.VIMEO
					: process.env.RAZZLE_VIMEO,
				...
				SKOOB: nodeIsProduction
					? process.env.SKOOB
					: process.env.RAZZLE_SKOOB,
				...
				SLACK: nodeIsProduction
					? process.env.SLACK
					: process.env.RAZZLE_SLACK,
				...
				GHOST: nodeIsProduction
					? process.env.GHOST
					: process.env.RAZZLE_GHOST,
